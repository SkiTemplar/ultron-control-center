...
```powershell
iwr -useb https://raw.githubusercontent.com/SkiTemplar/ultron/v15.5.13/bootstrap.ps1 | iex
```

```bash
curl -fsSL https://raw.githubusercontent.com/SkiTemplar/ultron/v15.5.13/bootstrap.sh | bash
```
