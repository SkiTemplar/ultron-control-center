# Changelog Archive (pre-2.0 history)

This file holds the v15.x and earlier history of ULTRON Control Center.
The live changelog at `CHANGELOG.md` only tracks v2.x onwards.
Archived 2026-05-23 during the v2.3 cleanup pass.
