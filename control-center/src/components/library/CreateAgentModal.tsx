// P5 — In-app new agent modal. Validates kebab-case, builds frontmatter
// on the backend.
      ...
      <div className="flex max-h-[85vh] w-[min(640px,92vw)] flex-col rounded-md border border-[var(--color-border)] bg-[var(--color-surface-1)] shadow-xl">
        ...
        <div className="flex-1 space-y-3 overflow-y-auto p-4 text-sm">
            ...
            {tools.length > 0 && (
              <div className="mt-1 flex flex-wrap gap-1">
                {tools.map((t) => (
                  <span
                    key={t}
                    className="rounded bg-[var(--color-surface-2)] px-2 py-0.5 font-mono text-xs"
                  >
                    {t}
                  </span>
                ))}
          ...
          <label className="block">
            ...
            <textarea
              className="mt-1 h-44 w-full rounded border border-[var(--color-border)] bg-[var(--color-surface-2)] px-2 py-1 font-mono text-xs outline-none"
              value={body}
