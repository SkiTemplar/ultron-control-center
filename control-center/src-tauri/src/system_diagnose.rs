...
pub async fn diagnose_with_ai_inner(
    ...
    // Control Center 2.0: no internal AI router. Provider comes from the
    // frontend or defaults to claude; model is the provider's account default.
    ...
    // CLI WITHOUT auto-submitting. This avoids the (perceived) auto-send
