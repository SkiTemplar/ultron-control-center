...
pub(crate) fn all() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        maria_perfiles::maria_perfiles_listar,
        maria_perfiles::maria_perfil_guardar,
        maria_perfiles::maria_perfil_activar,
        ...
        maria_threads::maria_thread_rename,
        maria_threads::maria_thread_folder,
