...
// Listas de frases (cross-project + meta/introspectivas) — extraidas a fichero
// hermano (limite 800 lineas, cat7.3). Frases CON espacios, nunca substrings
// cortos (leccion routing 2026-06-05).
#[path = "rules_phrases.rs"]
mod rules_phrases;
pub use rules_phrases::detect_cross_project;
use rules_phrases::META_INTROSPECTIVE_PHRASES;
