// App lifecycle commands: uninstall and in-place update + relaunch.
// These are Windows-only PowerShell scripts spawned in a new terminal
// window (fire-and-forget). Non-Windows returns an error stub.
