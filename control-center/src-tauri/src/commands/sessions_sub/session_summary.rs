...
#[tauri::command]
pub async fn summarize_session_activity(session_id: String) -> Result<String, String> {
    // route() es bloqueante (reqwest::blocking + CLIs con timeout de hasta 90s):
    // todo el cuerpo va a un blocking thread para no congelar el main thread.
