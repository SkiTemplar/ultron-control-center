...
// Higiene 2026-08-11 (audit 08-09 #45): fuera read_plugin_info y
// check_plugin_updates — superseded por list_all_plugins y
// plugin_check_updates_bulk (SHA-aware) y nunca registrados.
