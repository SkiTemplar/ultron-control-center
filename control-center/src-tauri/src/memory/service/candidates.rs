...
impl MemoryService {
    ...
    pub(crate) fn approve_candidate_on(
        ...
        let normalized = super::super::texthash::normalize_text(&preview.searchable_text());
        let hash = super::super::texthash::content_hash(&normalized);
...
// Tests (approve-gate + near-dup) — extraidos a fichero hermano (cat7.3).
#[cfg(test)]
