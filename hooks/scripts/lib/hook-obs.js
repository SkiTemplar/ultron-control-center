 ...
 *
 * Por que aqui y no en un .jsonl aparte: hook-timing.jsonl ya tiene lector
 * (`HookFiresReport` del backend pinta la ficha de cada hook y arrastra la
 * linea cruda), asi que lo anotado se ve HOY en la app. Un log nuevo seria
 * dato sin punto de consumo (mandamiento 12).
 *
 ...
 * publico. Si algun dia hiciera falta meter texto libre, pasaria antes por
 * `redactSecrets` de lib/security-helpers.js.
 *
