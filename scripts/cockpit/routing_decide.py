...
Usage from mode handlers / cockpit scripts:
    ...
    pick = decide_persona(["gamedev-engineer", "senior-engineer"], context="ue5 multiplayer")
    if pick is None:
...
CLI:
    routing_decide.py decide --candidates gamedev-engineer senior-engineer  # try a decision
    routing_decide.py inspect --candidates gamedev-engineer senior-engineer # show edge stats
