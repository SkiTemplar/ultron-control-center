...
MASTER = [
    ...
    },
    {
        ...
        "description": (
            ...
            "   - ¿Skills? (paquetes core + opt-in slots vacíos) — boolean toggles.\n"
            "   - ¿Features opcionales? News, Gaming tab, Memory visual,\n"
            "     Personal — boolean toggles que activan/desactivan tabs.\n"
            "4) Skill naming convention: alias genéricos\n"
            "   (orchestrator/sys-admin/game-dev/finance/writer) — los\n"
            "   forks rellenan slots opt-in con sus propias personas.\n"
