...
def _wellknown() -> list[dict]:
    ...
    return [
        ...
        {
            "name": "windows-admin",
            "aliases": ["windows-admin"],
            "source": "persona",
            "triggers": ["windows-admin", "windows-admin", "assistant mode", "help me organize", "personal assistant"],
        ...
        },
        {
            ...
            "aliases": ["business-strategist"],
            "source": "persona",
            "triggers": ["ventas", "sales", "pitch", "persuasion", "negociación",
                         "negotiation", "monetize", "pricing", "GTM", "SaaS"],
            "tags": ["persona", "business"],
            "cost_tier": "low",
            "dispatcher_priority": 3,
            "deprecated": False,
            "replaces": ["business-strategist"],
            "last_used": None,
            "last_synced": today,
            "description": "B2B SaaS business strategist — niche, validation, model, pricing, GTM, sales",
        },
        {
            "name": "python-pro",
            "source": "plugin",
