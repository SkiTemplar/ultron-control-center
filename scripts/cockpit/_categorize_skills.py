...
SKILL_MAP = {
    ...
    "mcp-builder":                   ("meta",      "alfred",        "S1", "HIGH",   "executor"),
    ...
    "php-pro":                       ("programming", "pana",        "S3", "MEDIUM", "executor"),
    ...
    "shader-fundamentals":           ("frontend",  "don-claudio",   "S4", "HIGH",   "executor"),
    ...
    "laravel-specialist":            ("backend",   "pana",          "S3", "MEDIUM", "executor"),
    "rails-expert":                  ("backend",   "pana",          "S3", "MEDIUM", "executor"),
    "symfony-specialist":            ("backend",   "pana",          "S3", "MEDIUM", "executor"),
    ...
    "payment-integration":           ("backend",   "pana",          "S3", "MEDIUM", "executor"),
    ...
    # ── DATABASE & ORM (S3/S4) ───────────────────────────────
    "postgres-pro":                  ("database",  "pana",          "S4", "HIGH",   "executor"),
    "database-administrator":        ("database",  "pana",          "S4", "HIGH",   "executor"),
    "database-optimizer":            ("database",  "pana",          "S3", "MEDIUM", "executor"),
    "database-schema-designer":      ("database",  "pana",          "S3", "MEDIUM", "utility"),
    "database-lookup":               ("database",  "pana",          "S3", "MEDIUM", "utility"),
    "prisma-expert":                 ("database",  "pana",          "S4", "HIGH",   "executor"),
    "supabase":                      ("database",  "pana",          "S4", "HIGH",   "executor"),
    "supabase-postgres":             ("database",  "pana",          "S4", "HIGH",   "executor"),
    "sql-pro":                       ("database",  "pana",          "S3", "MEDIUM", "executor"),
    ...
    "prompt-engineer":               ("ai-ml",     "alfred",        "S3", "MEDIUM", "utility"),
    "multi-agent-coordinator":       ("ai-ml",     "alfred",        "S3", "MEDIUM", "executor"),
    ...
    "data-engineer":                 ("data",      "pana",          "S4", "HIGH",   "executor"),
    ...
    # ── TESTING & QA (S3/S4) ─────────────────────────────────
    "qa-expert":                     ("testing",   "don-claudio",   "S3", "MEDIUM", "executor"),
    "test-automator":                ("testing",   "don-claudio",   "S3", "MEDIUM", "executor"),
    "mutation-testing":              ("testing",   "don-claudio",   "S4", "HIGH",   "reviewer"),
    "property-based-testing":        ("testing",   "don-claudio",   "S4", "HIGH",   "utility"),
    "spec-to-code-compliance":       ("testing",   "don-claudio",   "S3", "HIGH",   "reviewer"),
    "webapp-testing":                ("testing",   "don-claudio",   "S3", "MEDIUM", "executor"),
    "ask-questions-first":           ("testing",   "alfred",        "S3", "MEDIUM", "utility"),
    "ask-questions-if-underspecified":("testing",  "alfred",        "S3", "MEDIUM", "utility"),
    "playwright-skill":              ("testing",   "don-claudio",   "S3", "MEDIUM", "executor"),
    "testing-handbook-generator":    ("testing",   "don-claudio",   "S3", "MEDIUM", "utility"),
    ...
    # ── OFFICE & DOCUMENTS (S3) ──────────────────────────────
    "docx":                          ("office",    "alfred",        "S3", "MEDIUM", "executor"),
    "pdf":                           ("office",    "alfred",        "S3", "MEDIUM", "executor"),
    "pptx":                          ("office",    "alfred",        "S3", "MEDIUM", "executor"),
    "xlsx":                          ("office",    "alfred",        "S3", "MEDIUM", "executor"),
    "markitdown":                    ("office",    "alfred",        "S3", "MEDIUM", "utility"),

    # ── GAME DEVELOPMENT (S3/S4) ─────────────────────────────
    "game-developer":                ("game",      "don-claudio",   "S4", "HIGH",   "executor"),
    "ue5-dev":                       ("game",      "don-claudio",   "S4", "HIGH",   "utility"),
    "unreal-engine":                 ("game",      "don-claudio",   "S4", "HIGH",   "executor"),
    "dwarf-expert":                  ("game",      "don-claudio",   "S4", "HIGH",   "executor"),
    "pufferlib":                     ("game",      "don-claudio",   "S4", "HIGH",   "executor"),

    # ── ENGINEERING (CROSS-CUTTING) (S3/S4) ──────────────────
    "api-design-reviewer":           ("engineering","terry-davis",  "S3", "MEDIUM", "reviewer"),
    "code-review-excellence":        ("engineering","don-claudio",  "S3", "MEDIUM", "reviewer"),
    ...
    "second-opinion":                ("engineering","alfred",       "S3", "HIGH",   "reviewer"),
    ...
    "license-engineer":              ("engineering","alfred",       "S3", "MEDIUM", "utility"),
    ...
    "claude-skills":                 ("engineering","alfred",       "S3", "MEDIUM", "utility"),
    "claude-in-chrome-troubleshooting":("engineering","alfred",     "S3", "MEDIUM", "utility"),
    "context-manager":               ("engineering","alfred",       "S3", "MEDIUM", "utility"),
    "get-available-resources":       ("engineering","alfred",       "S3", "MEDIUM", "utility"),

    # ── WORKFLOW & UTILITIES (S3) ─────────────────────────────
    "antivibe":                      ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "developer-first":               ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "everything-claude-code":        ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "hyperframes":                   ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "news-publisher":                ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "superpowers":                   ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "loki-mode":                     ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "let-fate-decide":               ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "knowledge-synthesizer":         ("workflow",  "manolo-lama",   "S3", "MEDIUM", "utility"),
    "agentic-actions-auditor":       ("workflow",  "alfred",        "S3", "MEDIUM", "reviewer"),
    "agent-installer":               ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "agent-organizer":               ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "guidelines-advisor":            ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "audit-context-building":        ("memory",   "alfred",        "S3", "HIGH",   "reviewer"),
    "trailmark":                     ("memory",   "alfred",        "S3", "MEDIUM", "utility"),
    "context-manager":               ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),
    "task-distributor":              ("workflow",  "alfred",        "S3", "MEDIUM", "executor"),
    "workflow-orchestrator":         ("workflow",  "alfred",        "S3", "MEDIUM", "executor"),
    "it-ops-orchestrator":           ("devops",    "tio-gilito",    "S3", "MEDIUM", "executor"),
    ...
    # ── SLACK & COMMS (S3) ───────────────────────────────────
    "slack-expert":                  ("workflow",  "alfred",        "S3", "MEDIUM", "executor"),
    "slack-gif-creator":             ("workflow",  "alfred",        "S3", "MEDIUM", "utility"),

    # ── WORDPRESS (S3) ───────────────────────────────────────
    "wordpress-master":              ("backend",   "pana",          "S3", "MEDIUM", "executor"),
...
def apply_categorization():
    manifest_path = Path(r"C:\Users\USER\.ultron\skill_manifest.json")
