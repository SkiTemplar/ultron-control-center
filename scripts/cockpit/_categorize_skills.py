...
SKILL_MAP = {
    ...
    "terry-davis":                   ("persona",   "senior-engineer",   "S2", "ULTRA",  "sub-orchestrator"),
    ...
    "mike-tyson":                    ("persona",   "ui-designer",    "S2", "HIGH",   "sub-orchestrator"),
    "business-strategist":           ("persona",   "business-strategist","S2", "HIGH",   "utility"),
    "jordan-belfort":                ("persona",   "business-strategist","S2", "HIGH",   "utility"),
    ...
    "investment-advisor":            ("persona",   "investment-advisor",        "S2", "HIGH",   "utility"),
    "warren":                        ("persona",   "investment-advisor",        "S2", "HIGH",   "utility"),
    "research-explainer":            ("persona",   "research-explainer",      "S2", "HIGH",   "utility"),
    "einstein":                      ("persona",   "research-explainer",      "S2", "HIGH",   "utility"),
    "tolkien":                       ("persona",   "tolkien",       "S2", "MEDIUM", "utility"),
    "profesor-fisica":               ("persona",   "research-explainer",      "S2", "MEDIUM", "utility"),
    ...
    "fintech-engineer":              ("backend",   "investment-advisor",        "S4", "HIGH",   "executor"),
    ...
    "quant-analyst":                 ("data",      "investment-advisor",        "S4", "HIGH",   "executor"),
    ...
    "risk-manager":                  ("business",  "investment-advisor",        "S4", "HIGH",   "executor"),
    "legal-advisor":                 ("business",  "investment-advisor",        "S4", "HIGH",   "executor"),
    ...
    # ── FINANCE (S3/S4) ──────────────────────────────────────
    "quant-analyst":                 ("finance",   "investment-advisor",        "S4", "HIGH",   "executor"),
    "risk-manager":                  ("finance",   "investment-advisor",        "S4", "HIGH",   "executor"),
    "fintech-engineer":              ("finance",   "investment-advisor",        "S4", "HIGH",   "executor"),
