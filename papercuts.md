...
2026-09-25 · import_terrain_mesh.py por commandlet (-run=pythonscript) dejó los SM_* con el código C++ anterior tras recompilar (colores pálidos) · reconstruir con build_static_mesh desde el editor abierto (MCP execute_python) y guardar · tortunabo
