...
context.md · plans/MEGA-PLAN-v15.md + PLANS.json · references/{routing-tables,knowledge-domains,changelog}.md · `brain_index.py query` · `ultron doctor [--fix|--health-check|--security]`.

---

## USER

Grado Ing. Programación + PROGRAM_A Gráfica · UNIVERSITY · Europe/Madrid · Stack C++ (UE5) · C# (Unity) · TS · Python. Email user@example.com.

---

*Source-of-truth: vault L2 + brain_index FTS5. Esta es solo orientación.*
